    ...
    <header id="primary-header" role="banner">
        <div id="header-inner">
            ...
            <div class="nav-container-container">
                <button id="hamburger">
                    <svg class="burger" width="30" viewBox="0 0 30 30">
                        <use xlink:href="#hamburger-icon"></use>
                    </svg>

                    <svg class="close" width="30" viewBox="0 0 30 21">
                        ...
                        foreach( $menu_items as $menu_item ) {
                            if( $menu_item->menu_item_parent == 0 ) {
                                ...
                                if( $bool == true && count( $menu_array ) > 0 ) {
                                    ...
                                    $menu_list .= '<defs></defs>';
                                    $menu_list .= '<g id="Desktop-UI" stroke="none" stroke-width="1">';
                                    $menu_list .= '<g id="Homepage" transform="translate(-1170.000000, -51.000000)">';
